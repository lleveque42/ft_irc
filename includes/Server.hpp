...
/*   Updated: 2022/11/24 12:57:45 by arudy            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define ERR_BADCHANNELKEY(client, chan_name) (":" + std::string(client) +" 475 " RED + std::string(chan_name) + " :Cannot join channel (+k)" RESET "\r\n")
